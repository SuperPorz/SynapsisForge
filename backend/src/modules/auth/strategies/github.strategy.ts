...
export class GithubStrategy extends PassportStrategy(Strategy, 'github') {
  constructor(
    ...
    super({
      clientID: configService.get('GH_CLIENT_ID', { infer: true }),
      clientSecret: configService.get('GH_CLIENT_SECRET', { infer: true }),
      callbackURL: configService.get('GH_CALLBACK_URL', { infer: true }),
      scope: ['user:email'],
    });
  }
